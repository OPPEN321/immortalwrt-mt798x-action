...
持续适配市面上的 MTK 设备，并不断新增机型支持，覆盖面更广。
2️⃣ **扩展大容量机型支持**  
已适配如 **磊科 N60 PRO 512MB ROM** 等大容量版本设备，让更多增强机型可直接使用。
3️⃣ **精简插件并集成作者私有源**  
固件默认保持精简，并提供作者自建软件源，可通过更新软件源仓库自由安装更多插件。
4️⃣ **内置 LLVM-BPF 支持**  
支持 eBPF 相关功能，可直接通过作者私有源快速安装 **大鹅** 等进阶工具。
5️⃣ **一键风格化 iStoreOS**  
使用作者提供的一键美化脚本，对 iStoreOS 进行全面 UI & 体验风格化处理：  
`bash <(curl -fsSL https://opkg.kejizero.xyz/Scripts/custom.sh)`
6️⃣ **支持一键在线/本地编译固件**  
提供自动化编译脚本，可快速生成属于你的定制固件，无需复杂环境配置。
